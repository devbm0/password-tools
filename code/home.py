...
def home_main(root):
    ...
    main_label = ctk.CTkLabel(frame, text="Welcome to Password Tools!", font=('Open Sans', 48, 'bold'), fg_color='transparent')
    main_label.place(relx=0.5, y=50, anchor='center')

    sub_text = ctk.CTkTextbox(frame, width=500, height=330, wrap='word', font=('Open Sans', 20), fg_color='transparent')
    sub_text.place(relx=0.5, y=260, anchor='center')
    ...
    image_label.place(relx=0.5, y=500, anchor='center')